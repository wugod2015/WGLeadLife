...
public abstract class BaseRecyclerAdapter extends Adapter<ViewHolder> implements
    ...
    public static interface OnRecyclerItemClickListener {
        void onRecyclerItemClick(View view, Object item);
    }
    ...
    public static interface OnRecyclerItemLongClickListener {
        ...
        void onRecyclerItemLongClick(View view, Object item);
    }

    private OnRecyclerItemLongClickListener mOnItemLongClickListener = null;
    ...
    public void onClick(View v) {
        ...
        if (mOnItemClickListener != null) {
            // 注意这里使用getTag方法获取数据
            mOnItemClickListener.onRecyclerItemClick(v, v.getTag());
        }
    }
    ...
    public boolean onLongClick(View v) {
        if (mOnItemLongClickListener != null) {
            // 注意这里使用getTag方法获取数据
            mOnItemLongClickListener.onRecyclerItemLongClick(v, v.getTag());
        }
        return false;
    }
}
